import {ApiBulkUpgradePick, ApiBundleEntry, ApiMatrixIntegrityEntry} from '../shared/Api/ApiTypes.js';
import {ConfigProjectType} from '../backend/Config/Config.js';
import {DependencyType} from '../backend/Project/PackageManifest.js';
import {MatrixResponse, MatrixRow, MatrixRowStatus} from '../backend/Matrix/MatrixBuilder.js';
import {BinarySeverity, BinarySummary} from '../backend/Security/BinaryScanner.js';
import {CadenceLevel, CadenceSummary} from '../backend/Security/CadenceScanner.js';
import {FreshnessLevel, FreshnessSummary} from '../backend/Security/FreshnessScanner.js';
import {IntegritySeverity} from '../backend/Security/IntegrityScanner.js';
import {LicenseSeverity, LicenseSummary} from '../backend/Security/LicenseScanner.js';
import {MaintainerSeverity, MaintainerSummary} from '../backend/Security/MaintainerScanner.js';
import {PatternSeverity} from '../backend/Security/PatternScanner.js';
import {ProvenanceLevel, ProvenanceSummary} from '../backend/Security/ProvenanceScanner.js';
import {ScriptSeverity} from '../backend/Security/ScriptScanner.js';
import {DeprecationLevel, DeprecationSummary} from '../backend/Security/DeprecationScanner.js';
import {ExternalSeverity, ExternalSummary} from '../backend/Security/ExternalSourcesScanner.js';
import {CapabilitySeverity, CapabilitySummary} from '../backend/Security/CapabilityScanner.js';
import {ManifestRedFlagSeverity, ManifestRedFlagsSummary} from '../backend/Security/ManifestRedFlagsScanner.js';
