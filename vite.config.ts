...
class Server {
        ...
        return {
            ...
            configureServer: function(server: ViteDevServer) {
                ...
                app.get('/api/projects', async(_req, res) => {
                    ...
                    const response: ApiProjectsResponse = {projects: result, editor: editor};
    ...
    private static _instantiateProject(
        ...
        if (body.type === ConfigProjectType.local) {
            ...
            return new ProjectLocal(absRoot, body.name, {hidden: hidden, configIndex: configIndex, templates: templates});
        }
