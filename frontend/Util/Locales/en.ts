...
export const TRANSLATIONS_EN: Record<string, string> = {
    ...
    'Version pinned by the project\'s templates (— = not pinned, varies = different per project)':
        'Version pinned by the project\'s templates (— = not pinned, varies = different per project)',
    'No template pins this package': 'No template pins this package',
    'varies': 'varies',
    'All projects satisfy the template pin': 'All projects satisfy the template pin',
    ...
    'Loading upstream links …': 'Loading upstream links …',
    'Ignore': 'Ignore',
    'Re-enable': 'Re-enable',
    'Ignore this finding for {pkg}': 'Ignore this finding for {pkg}',
    'Re-enable this finding for {pkg}': 'Re-enable this finding for {pkg}',
    'Ignore this CVE': 'Ignore this CVE',
    'Re-enable this CVE': 'Re-enable this CVE',
    'Ignored findings': 'Ignored findings',
    'Loading ignored findings …': 'Loading ignored findings …',
    'No findings are currently ignored.': 'No findings are currently ignored.',
    ...
    'Remove this entry — re-enables the finding': 'Remove this entry — re-enables the finding',
    'Overview': 'Overview',
    'Description': 'Description',
    'This package ships without a description.': 'This package ships without a description.',
    'Links': 'Links',
    'Repository': 'Repository',
    'Homepage': 'Homepage',
    'No upstream links declared.': 'No upstream links declared.',
    'Quick facts': 'Quick facts',
    'Tarball files': 'Tarball files',
    'README in tarball': 'README in tarball',
    'yes': 'yes',
    'no': 'no',
    'Engines': 'Engines',
    ...
    'GitHub token (raises rate-limit to 5000/h, $ENV_VAR supported)': 'GitHub token (raises rate-limit to 5000/h, $ENV_VAR supported)',
    'Graph': 'Graph',
    'Code-Map': 'Code-Map',
    'Building source graph …': 'Building source graph …',
    'Source graph is not supported for this project type in v1.': 'Source graph is not supported for this project type in v1.',
    '{files} files, {edges} import edges. Hover a node to highlight its neighbours.': '{files} files, {edges} import edges. Hover a node to highlight its neighbours.',
    '{files} files, {edges} import edges. Drag a node to nudge the layout.': '{files} files, {edges} import edges. Drag a node to nudge the layout.',
    'Lines': 'Lines',
    'Folder': 'Folder',
    'Imports': 'Imports',
    'Imported by': 'Imported by',
    'Imports ({n})': 'Imports ({n})',
    'Imported by ({n})': 'Imported by ({n})',
    ...
    'External deps ({n})': 'External deps ({n})',
    ...
    'Config': 'Config',
    '{n} lines': '{n} lines',
    'Graph too large — showing the {kept} most-connected files (of {total}).': 'Graph too large — showing the {kept} most-connected files (of {total}).'
};