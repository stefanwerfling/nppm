...
export const TRANSLATIONS_DE: Record<string, string> = {
    ...
    'No template pins this package': 'Kein Template pinnt dieses Paket',
    'varies': 'varies',
    'All projects satisfy the template pin': 'Alle Projekte erfüllen den Template-Pin',
    'At least one project installed a version that differs from the template pin':
        'Mindestens ein Projekt hat eine Version installiert, die vom Template-Pin abweicht',
    'Template pins {pin} — installed {installed}':
        'Template pinnt {pin} — installiert ist {installed}',
    'License': 'Lizenz',
    ...
    'Loading upstream links …': 'Lade Upstream-Links …',
    'Ignore': 'Ignorieren',
    'Re-enable': 'Wieder aktivieren',
    'Ignore this finding for {pkg}': 'Diesen Befund für {pkg} ignorieren',
    'Re-enable this finding for {pkg}': 'Diesen Befund für {pkg} wieder aktivieren',
    'Ignore this CVE': 'Diese CVE ignorieren',
    'Re-enable this CVE': 'Diese CVE wieder aktivieren',
    'Ignored findings': 'Ignorierte Befunde',
    'Loading ignored findings …': 'Lade ignorierte Befunde …',
    'No findings are currently ignored.': 'Aktuell sind keine Befunde ignoriert.',
    'Suppressed via the Ignore button on the PackageDetailPanel Security tab. Removing an entry here re-enables the finding everywhere — badges, scoring, and the per-package card.':
        'Über den „Ignorieren"-Button im Sicherheits-Tab des Paket-Details unterdrückt. Eintrag hier entfernen aktiviert den Befund überall wieder — Badges, Scoring und Karte im Paket-Detail.',
    'Identifier': 'Identifier',
    'Remove this entry — re-enables the finding': 'Eintrag entfernen — aktiviert den Befund wieder',
    'Overview': 'Überblick',
    'Description': 'Beschreibung',
    'This package ships without a description.': 'Dieses Paket wird ohne Beschreibung ausgeliefert.',
    'Links': 'Links',
    'Repository': 'Repository',
    'Homepage': 'Homepage',
    'No upstream links declared.': 'Keine Upstream-Links deklariert.',
    'Quick facts': 'Kurzdaten',
    'Tarball files': 'Tarball-Dateien',
    'README in tarball': 'README im Tarball',
    'yes': 'ja',
    'no': 'nein',
    'Engines': 'Engines',
    'Bin commands': 'Bin-Befehle',
